...
public class ReportManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Report Type", "Description", "Report By"
            }
        ) {
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (searchText.trim().length() == 0) {
            ...
            sorter.setRowFilter(RowFilter.regexFilter("(?i)" + searchText)); // Perform case-insensitive search
        }
    }

    public void refreshTable() {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);  // Reset the table row count to 0

        // Create an instance of the Report class
        report = new Report();

        // Now call getData() on the instance of the Report class
        List<Object[]> allReportDetails = report.getData();

        // Populate the table with the fetched data
        for (Object[] row : allReportDetails) {
            model.addRow(row);
        }
    }


    // This method could be used to handle the search dynamically as the user types.
    private void searchTextFieldKeyReleased(java.awt.event.KeyEvent evt) {
        searchActionPerformed(null);  // Reuse search logic to filter as the user types.
    }
