...
public class AssetManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Asset ID");

        jLabel4.setText("Asset Name");

        jLabel5.setText("Asset Description");

        jLabel6.setText("Asset Price");
        ...
        jLabel7.setText("Asset Quantity");

        jLabel8.setText("Asset Company");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(61, 61, 61)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(price, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // Validation
        if (id.isEmpty() || name.isEmpty() || description.isEmpty() || quantity.isEmpty() || company.isEmpty() || price.isEmpty()) {
        ...
        asset.setAssetCompany(company);
        asset.setAssetPrice(price);

        asset.addData();
        refreshTable(); // Update the table view
    }
//GEN-LAST:event_addActionPerformed
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        String company = this.company.getText();
        String price = this.price.getText();
        asset = new Asset(id,name,description, quantity, company,price);
        asset.updateData();
...
//GEN-LAST:event_deleteActionPerformed
    ...
    public void refreshTable() {
        ...
        // Fetch updated data from in-memory list
